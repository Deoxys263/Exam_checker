                ...
                <div class="row px-2">
                    <div class="col-md-8">
                        <ol class="breadcrumb pt-2">
                            ...
                            <li class="breadcrumb-item"><a href="<?php echo e(route('admin.backend.submenu.index',[$id])); ?>">Backend Sub Menu</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Create</li>
                          </ol>
                    </div>
                <div class="col-md-4 text-right">
                    <div class="btn-group text-end mt-2">
                        <a href="<?php echo e(route('admin.backend.submenu.index',[$id])); ?>">
                  ...
                  <div class="card p-2">
                    <span class="h5">Create Backend Sub Menu</span>
                        <div class="card-body demo-vertical-spacing demo-only-element">
                            ...
                            <?php echo e(Form::open(['url'=>'admin/backend/submenu/store'])); ?>
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-12 mb-2 mt-2">
                                        <div class="form-group">
                                            ...
                                            <?php echo e(Form::hidden('backendmenu_id',$id, ['class'=>'form-control', 'placeholder'=>'Enter Menu Name'])); ?>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\wamp64\www\exam_system\resources\views/backend/submenu/create.blade.php ENDPATH**/ ?>