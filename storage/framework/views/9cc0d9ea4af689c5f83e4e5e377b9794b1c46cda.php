                    ...
                    <div class="row px-2">
                        ...
                        <div class="col-md-4 text-right">
                            <div class="btn-group text-end mt-2">
                                <?php if(isset($chapter->subject_id)): ?>
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create topics')): ?>
                                    <a href="<?php echo e(route('admin.topics.create', [(isset($id)?$id:null)])); ?>">
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view questions')): ?>
                                                                        <a href="<?php echo e(url('admin/question/master/' . $data->topic_id)); ?>"
                                                                            class="btn btn-success btn-sm m-1"><i class="fas fa-question"></i> &nbsp; Questions</a>
                                                                    <?php endif; ?>

                                                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('update topics')): ?>
                                                                        <a href="<?php echo e(url('admin/topics/master/edit/' . $data->topic_id)); ?>"
                                                                    ...
                                                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete topics')): ?>
                                                                        <?php echo Form::open([
                                                                            'method' => 'get',
                                                                            'url' => ['admin/topics/master/delete', $data->topic_id],
                                                                ...
                                                                <td>
                                                                    <?php if(isset($data->subjects->subject_name)): ?>
                                                                        <?php echo e($data->subjects->subject_name); ?>

                                                                    <?php endif; ?>
                                                                </td>
                                                                <td> <?php echo e($data->topic_name); ?> </td>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\wamp64\www\exam_system\resources\views/backend/topics/index.blade.php ENDPATH**/ ?>