            ...
            <div class="card-body">
                ...
                <div class="row mt-2 mb-2">
                    ...
                    <div class="col-md-3">
                        ...
                        <?php echo e(Form::select('checker_id',$checkers, $selected_checker_id,['class'=>'form-control','placeholder'=>'Select Checker'])); ?>

                    </div>
                    <div class="col-md-3">
                        <label for="">Status</label>
                        <?php echo e(Form::select('status',['uploaded'=>'Uploaded','checked'=>'Checked','rejected'=>'Rejected'], $selected_status,['class'=>'form-control','placeholder'=>'Select Status'])); ?>
                    ...
                    <table class="table zero-configuration table-bordered" id="batch_table"
                        ...
                        <tbody>
                            <?php if(isset($submissions) && count($submissions) > 0): ?>
                                <?php $__currentLoopData = $submissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $record): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td><?php echo e($loop->index + 1); ?></td>
                                        <td>SP<?php echo e($record->id); ?></td>
                                        <td><?php echo e((isset($record->package->package_name)?$record->package->package_name:'--')); ?></td>
                                        <td><?php echo e((isset($record->filename->paper_name)?$record->filename->paper_name:'--')); ?></td>
                                        <td><?php echo e((isset($record->student->student_name)?$record->student->student_name:'--')); ?></td>
                                        <td><?php echo e((isset($record->checker->first_name)?$record->checker->first_name:'--')); ?> <?php echo e((isset($record->checker->last_name)?$record->checker->last_name:'--')); ?></td>
                                        <td><?php echo e((isset($record->status)?ucfirst($record->status):'--')); ?></td>
                                        <td><?php echo e((isset($record->score)?$record->score:'--')); ?>/<?php echo e((isset($record->marks)?$record->marks:'--')); ?></td>
                                        <td><?php echo e((isset($record->created_at)?date('d/m/Y h:i:s', strtotime($record->created_at)):'--')); ?></td>
                                        <td><?php echo e((isset($record->approved_on)?date('d/m/Y h:i:s', strtotime($record->approved_on)):'--')); ?></td>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\wamp64\www\exam_system\resources\views/backend/reports/checkings_report.blade.php ENDPATH**/ ?>