...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            ...
            <!-- Layouts -->
            <?php if(isset($backend_menu) && count($backend_menu) > 0): ?>
        <?php $__currentLoopData = $backend_menu; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        
        <?php if(isset($menu->has_submenu) && $menu->has_submenu == 1): ?>
        <!-- Layouts -->
        <li class="menu-item ">
            <a href="javascript:void(0);" class="menu-link menu-toggle">
                <i class="<?php echo e($menu->icon); ?> mx-2 text-primary"></i>
                <div data-i18n="<?php echo e($menu->menu_name); ?>"><?php echo e($menu->menu_name); ?></div>
            </a>
            ...
            <?php if(isset($submenu) && count($submenu) > 0): ?>
                ...
                <ul class="menu-sub">
                    <li class="menu-item">
                        <a href="<?php echo e($route_name); ?>" class="menu-link">
                            <div data-i18n="<?php echo e($sub->menu_name); ?>"><?php echo e($sub->menu_name); ?></div>
                        </a>
                    </li>
                </ul>
        ...
        <li class="menu-item">
            <a href="<?php echo e($route_name); ?>" class="menu-link">
                <i class="<?php echo e($menu->icon); ?> mx-2 text-primary"></i>
                <div data-i18n="Analytics"><?php echo e($menu->menu_name); ?></div>
            </a>
        </li>
        <?php endif; ?>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH C:\wamp64\www\exam_system\resources\views/backend/includes/leftnav.blade.php ENDPATH**/ ?>