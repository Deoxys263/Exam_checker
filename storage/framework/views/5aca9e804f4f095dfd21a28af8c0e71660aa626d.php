...
<?php $__env->startSection('title', 'Edit Free Exam'); ?>
<?php $__env->startSection('page_name', 'Edit Free Exam'); ?>
<?php
    ...
    <div class="container m-0">
        <div class="row px-2">
            <div class="col-md-8">
                <ol class="breadcrumb pt-2">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Edit Free Exams</li>
                </ol>
            </div>
        ...
        <div class="container-xxl flex-grow-1 container mt-2">
          ...
          <div class="row">
            <div class="col-12">
                <div class="card p-2">
                  <span class="h4 p-2">Edit Free Exam</span>
                    <div class="card-body demo-vertical-spacing demo-only-element">
                        <?php echo $__env->make('backend.includes.errors', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        <?php echo e(Form::model($exam,['route' => 'admin.free.exam.update','files'=>'true'])); ?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-12 mt-1 mb-2">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::hidden('id', null, ['class' => 'form-control', 'required' => true, 'placeholder' => 'Enter Exam Name'])); ?>
                                ...
                                <div class="col-md-3 col-12 mt-1 mb-2">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::text('expiry_date', (isset($exam->expiry_date)?date('d/m/Y', strtotime(str_replace('-','/',$exam->expiry_date))):null), ['class' => 'form-control date', 'required' => true, 'placeholder' => 'Enter Negation'])); ?>
...
<script>
    ...
    {
        let selected_value= "<?php echo e((isset($exam->subject_id)?$exam->subject_id:0)); ?>";
        if(batch_id != ''){
            ...
            $.ajax({
                ...
                success:function(resp){
                    ...
                    $('#subject_id option[value='+selected_value+']').attr('selected',true);
                }
            });
        }
    }
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\wamp64\www\exam_system\resources\views/backend/free_exams/edit.blade.php ENDPATH**/ ?>