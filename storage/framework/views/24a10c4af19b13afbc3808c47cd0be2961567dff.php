...
<?php $__env->startSection('title', 'Missing Payments'); ?>
<?php $__env->startSection('page_name', 'missing_payments'); ?>
        ...
        <div class="row px-2">
            <div class="col-md-8">
                <ol class="breadcrumb pt-2">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Missing Payments</li>
                </ol>
            </div>
                            ...
                            <?php if(isset($payments) && count($payments) > 0): ?>
                                <?php $__currentLoopData = $payments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td>
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('update missing payments')): ?>
                                                <?php echo Form::open([
                                                    'method'=>'POST',
                                                    'url' => ['admin/missing/payments/convert', $payment->payment_tracking_id],
                                                    'style' => 'display:inline'
                                                    ]); ?>

                                                <?php echo Form::button('<i class="fas fa-check"></i>', ['type' => 'submit', 'class' => 'btn btn-info btn-sm','onclick'=>"return confirm('Are You Sure You want to convert this payment to success payment ?')"]); ?>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\wamp64\www\exam_system\resources\views/backend/payments/missing_payments.blade.php ENDPATH**/ ?>