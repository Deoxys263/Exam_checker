...
use Illuminate\Support\Str;
    ...
    if(auth()->check())
    {
        $activity = StudentActivity::where('student_id',Auth::user()->student_id)->take(20)->orderBy('id','desc')->get();
    }
                                ...
                                <?php if(isset($activity) && count( $activity) > 0): ?>
                                   ...
                                   <table>
                                       <tr style='margin-bottom:10px'>
                                           ...
                                           <td><span><?php echo e((isset($act->activity_string)?STR::limit($act->activity_string,70):'')); ?></span></td>
                                        </tr>
                                    </table>
                                    <hr class="activity_spacer_hr">
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\wamp64\www\exam_system\resources\views/frontend/home/index.blade.php ENDPATH**/ ?>