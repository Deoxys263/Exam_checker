                  ...
                  <div class="card p-2">
                    <span class="h5">Create Backend Menu</span>
                        <div class="card-body demo-vertical-spacing demo-only-element">
                            ...
                            <?php echo e(Form::model($menu,['url'=>'admin/backend/menu/update'])); ?>
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-12 mb-2 mt-2">
                                        <div class="form-group">
                                            ...
                                            <?php echo e(Form::hidden('backendmenu_id',null, ['class'=>'form-control', 'placeholder'=>'Enter Menu Name'])); ?>
                                    ...
                                    <?php
                                        $permission_id_array = (isset($menu->permission_ids)?explode(',',$menu->permission_ids):null);
                                    ?>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\wamp64\www\exam_system\resources\views/backend/menubar/edit.blade.php ENDPATH**/ ?>