        ...
        <div class="row px-2">
            <div class="col-md-8">
                <ol class="breadcrumb pt-2">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Questopn Paper Format</li>
                </ol>
            </div>
        <div class="col-md-4 text-right">
            <div class="btn-group text-end mt-2">
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create qp format')): ?>
                        <a href="<?php echo e(route('admin.qp.format.create')); ?>">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('update subjects')): ?>
                                                <a href="<?php echo e(url('admin/subjects/edit/' . $data->subject_id)); ?>" class="btn btn-primary btn-sm m-1"><i class="fas fa-pencil"></i></a>
                                            <?php endif; ?>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\wamp64\www\exam_system\resources\views/backend/format/index.blade.php ENDPATH**/ ?>