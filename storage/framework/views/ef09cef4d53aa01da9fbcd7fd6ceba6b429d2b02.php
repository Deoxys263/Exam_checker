...
?>
    ...
    <aside class="left-sidebar">
      ...
      <div>
        <div class="brand-logo d-flex align-items-center justify-content-between">
          <a href="<?php echo e(url('admin')); ?>" class="text-nowrap logo-img">
            <img src="<?php echo e(asset('public/assets/img/logos/logo.svg')); ?>" alt="" />
          </a>
    ...
    <!--  Sidebar End -->
<?php /**PATH G:\wamp64\www\checker\resources\views/backend/includes/leftnav.blade.php ENDPATH**/ ?>