...
<div class="bs-toast toast fade show bg-danger mx-3 mt-2" role="alert" aria-live="assertive" aria-atomic="true" style='position:absolute; float-right; right:0;'>
    <div class="toast-header p-0">
        <button type="button" class="btn-close" data-bs-dismiss="toast" aria-label="Close"></button>
    </div>
    <div class="toast-body p-3">
...
<?php /**PATH G:\wamp64\www\exam_system\resources\views/frontend/includes/alerts.blade.php ENDPATH**/ ?>